...
public void enterService() {
	...
	controller.readstudentsFromFile();
	controller.readTeachersFromFile();
	...
	while(!choice.equalsIgnoreCase("e")) {
		...
		switch(choice.toLowerCase()){
			...
			case "e":
				...
				controller.writeStudentsToFile();
				controller.writeTeachersToFile();
				return;
...
public void register() {
	...
	if(choice.equalsIgnoreCase("s")) {
		    ...
		    Student s = new Student(parseInt(login),name,surname,true, new HashMap<String, Float>(), 0.0f, false);
